                ...
                <div class="card p-0">
                    ...
                    <div class="card-body p-15">
                        <div class="basic-form">
                            <form action="{{ route('new-credit-voucher') }}" method="POST">
                                @csrf
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="creditVoucherTable">
                                                ...
                                                <tr id="1">
                                                    ...
                                                    <td class="align-middle p-l-15 p-r-15"><input type="text" name="transaction[0][debit]" class="form-control" onkeyup="creditVoucherTotalDebit()" readonly/></td>
                                                    <td class="align-middle p-l-15 p-r-15"><input type="text" name="transaction[0][credit]" class="form-control" onkeyup="creditVoucherTotalCredit()"/></td>
                                                </tr>
                                                <tr id="2">
                                                    <td class="align-middle p-l-15 p-r-15">
                                                        <select class="form-control" name="transaction[1][account_code]">
                                                            <option> -- Select Income Account --- </option>
                                                    ...
                                                    <td class="align-middle p-l-15 p-r-15"><input type="text" name="transaction[1][debit]" class="form-control" onkeyup="creditVoucherTotalDebit()" readonly/></td>
                                                    <td class="align-middle p-l-15 p-r-15"><input type="text" name="transaction[1][credit]" class="form-control" onkeyup="creditVoucherTotalCredit()"/></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <a href="javascript:void(0)" id="creditVoucherAddALine" class="btn btn-flat btn-primary m-t-15 m-b-15">Add A Line</a>
                                        <div class="col-md-6 offset-md-6 p-r-0">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <th>Total</th>
                                                        <td><input type="text" class="form-control" id="totalCreditVoucherDebit" name="total_debit" value="0" readonly/></td>
                                                        <td><input type="text" class="form-control" id="totalCreditVoucherCredit" name="total_crebit" value="0" readonly/></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                        <div class="form-group p-t-15 m-b-0">
                                            <input type="submit" id="creditVoucherSubmitBtn" name="btn" value="Save" class="btn btn-flat btn-primary btn-block"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
