        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0"  width="500" border="0" style="margin: 0 auto;">
            ...
            <tr>
                <td style="padding-top: 10px;">
                    <h2 style="margin: 0; font-family: sans-serif; color: #555; font-size: 12px; line-height: 12px; font-weight: bold; float: right; display: block; text-transform: uppercase;">Credit Voucher</h2>
                </td>
            </tr>
            <tr>
